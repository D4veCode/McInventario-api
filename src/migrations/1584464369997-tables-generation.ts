...
export class tablesGenertion1584467997971 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "inventarios" ("id" SERIAL NOT NULL, "cant" integer NOT NULL, "fecha_reg" TIMESTAMP default (now() AT TIME ZONE 'America/Caracas'), "fecha_ven" date, "valor_usd" NUMERIC(3, 2), "contratador" character varying(60), "fk_user" integer NOT NULL, "fk_don" integer NOT NULL, "fk_prod" integer NOT NULL, CONSTRAINT "PK_95497c8cd6a8604110c7a7cbf34" PRIMARY KEY ("id"))`, undefined);
