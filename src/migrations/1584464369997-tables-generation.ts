...
export class tablesGeneration1584464369997 implements MigrationInterface {
    name = 'tablesGeneration1584464369997'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "inventarios" ("id" SERIAL NOT NULL, "Cant" integer NOT NULL, "Fecha_reg" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, "Fecha_ven" TIMESTAMP WITH TIME ZONE DEFAULT now(), "Valor_Usd" real, "Contratador" character varying(60), "Fk_user" integer, "Fk_don" integer, "Fk_Prod" integer, CONSTRAINT "REL_4613ccfef3a0807c70fdff3443" UNIQUE ("Fk_user"), CONSTRAINT "REL_8343d3c61afa443c067b171fc5" UNIQUE ("Fk_don"), CONSTRAINT "REL_0ad1c33f3f1a8ed9801564950a" UNIQUE ("Fk_Prod"), CONSTRAINT "PK_95497c8cd6a8604110c7a7cbf34" PRIMARY KEY ("id"))`, undefined);
