...
export class Seeds1583897172301 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        /*
        await queryRunner.query(`Insert into users(id,correo,clave)values
        (1,'davidasb.27@gmail.com','123456'),
        (2,'ferdy.rod23@gmail.com','123456');`, undefined);
        await queryRunner.query(`
        Insert into empleados(id,nombre,apellido,ci,cargo,fk_user)values
        (1,'David','Serrada','29565150','Developer',1),
        (2,'Fernando','Rodriguez','24210861','Developer',2);`, undefined);
        await queryRunner.query(`Insert into donantes(id,Nombre,tip_id,num_id,direccion)values
        (1,'Veronica Vazquez','V','6913539','Macaracuay'),
        (2,'Campamento Ranita','J','123456789','Macaracuay'),
        (3,'Empresas Polar','J','987654321','Los Ruices');`, undefined);
        await queryRunner.query(`Insert into productos(id,nombre,marca,gr_paq,tipo)values
        ...
        (16,'Cambur','Artesanal',300,'Fruta');`, undefined);
        await queryRunner.query(`Insert into recetas(id,nombre,gr_persona)Values
        (1,'Harina Arepa',50),
        (2,'Pasta Corta',125),
        (3,'Pasta Larga',125),
        (4,'Atun',175);`, undefined);
        await queryRunner.query(`insert into inventarios (id, cant, fk_prod, fecha_reg, fecha_ven, valor_usd, contratador, fk_don, fk_user) values (2, 6, 3, '2020/02/02', '2021/01/13', 4.29, 'Diego Bastidas', 1, 1);
        ...
        insert into inventarios (id, cant, fk_prod, fecha_reg, fecha_ven, valor_usd, contratador, fk_don, fk_user) values (200, 10, 6, '2020/04/16', '2021/01/18', 5.42, 'David Serrada', 3, 2);`, undefined);
        await queryRunner.query(`insert into inventarios (id, cant, fk_prod, fecha_reg, fk_user) values (201, -6, 8, '2020/05/11', 2);
        ...
        insert into inventarios (id, cant, fk_prod, fecha_reg, fk_user) values (300, -7, 1, '2020/06/12', 1);`, undefined);
        */
    }

    public async down(queryRunner: QueryRunner): Promise<any> {
        /*
        await queryRunner.query(`delete from recetas;`, undefined);
        await queryRunner.query(`delete from inventarios;`, undefined);
        await queryRunner.query(`delete from productos;`, undefined);
        await queryRunner.query(`delete from donantes;`, undefined);
        await queryRunner.query(`delete from empleados;`, undefined);
        await queryRunner.query(`delete from users;`, undefined);
        await queryRunner.query(`ALTER SEQUENCE recetas_id_seq RESTART WITH 1;`, undefined);
        await queryRunner.query(`ALTER SEQUENCE inventarios_id_seq RESTART WITH 1;`, undefined);
        await queryRunner.query(`ALTER SEQUENCE productos_id_seq RESTART WITH 1;`, undefined);
        await queryRunner.query(`ALTER SEQUENCE donantes_id_seq RESTART WITH 1;`, undefined);
        await queryRunner.query(`ALTER SEQUENCE empleados_id_seq RESTART WITH 1;`, undefined);
        await queryRunner.query(`ALTER SEQUENCE users_id_seq RESTART WITH 1;`, undefined);
        */
    }
